...
// Placeholder data that matches the design
const students = ref([
  { name: 'Alex Johnson', avatar: 'https://i.pravatar.cc/40?img=1', quizzesTaken: 12, avgScore: 85, avgTime: 85 },
  { name: 'Alex Johnson', avatar: 'https://i.pravatar.cc/40?img=2', quizzesTaken: 12, avgScore: 85, avgTime: 85 },
  { name: 'Alex Johnson', avatar: 'https://i.pravatar.cc/40?img=3', quizzesTaken: 12, avgScore: 85, avgTime: 85 },
  { name: 'Alex Johnson', avatar: 'https://i.pravatar.cc/40?img=4', quizzesTaken: 12, avgScore: 85, avgTime: 85 },
  { name: 'Alex Johnson', avatar: 'https://i.pravatar.cc/40?img=5', quizzesTaken: 12, avgScore: 85, avgTime: 85 },
]);
</script>
